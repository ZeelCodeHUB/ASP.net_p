    ...
    <section class="rounded-md bg-black/40 p-1 ml-[500px] mr-[500px] mt-36">
        <div class="flex items-center justify-center bg-white px-4 py-10 sm:px-4 sm:py-6 lg:px-8">
            <div class="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
                ...
                <h2 class="text-2xl mt-5 font-bold leading-tight text-black">Account Recovery</h2>

                <a
                    href="Login.aspx"
                    title=""
                    class="font-semibold text-black transition-all duration-200 hover:underline">Enter Your mail to Recover Your Account
                </a>
                <div>
                            ...
                            <div>
                                ...
                                <div class="mt-2">
                                    <input
                                        ...
                                        type="email"
                                        placeholder="Enter Registerd E-mail" />
                                </div>
                            </div>
